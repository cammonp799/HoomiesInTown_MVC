...
function displayColocation()
{
    ...
    ?>
        ...
        <main>
            ...
            <article>
                <h1>
                    Rechercher une chambre <br/>
                    en colocation.
                </h1>
            
                <p>
                    Vous cherchez une chambre en colocation ? Ne cherchez plus ! Chez
                    <br/>
                    Hoomies In Town, nous vous proposons des logements en colocation
                <br/>, 
                    offrant des espaces tout confort et entièrement équipés.
                </p>
            </article>
            </section>
        ...
        <article id="appart2">
            ...
            <article class="container-list1">
                <h4>À partir de 420 €</h4>
                <p class="localisation">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
              ...
              <article id="appart4">
                ...
                <article class="container-list7">
                  <h4>À partir de 610 €</h4>
                  <p class="localisation">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="30"
